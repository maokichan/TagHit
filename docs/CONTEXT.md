...
已完成（细节见 DECISIONS 与 git log）：契约 v0 ✅ 旧 UI 吸收 ✅ 贡献点 v0 ✅ 真机接线 ✅ 字节闸门 ✅ 界面美化 ✅ 图片尺寸落库 ✅ 注册表 v0.1 ✅ 命令注册表 + 右键菜单闭环 ✅ 插件生态主线（SurfaceHost 标准容器 + 服务面 dialog/toast + config 仓 featureId:key + contentTab 槽 + HostApi 冻结面 + contributed 装载器，2026-09-07）✅ **视频缩略图 + 多选批量（D16，2026-09-07）** ✅ **无边框壳 + 自绘窗口三键 + 去默认菜单 + 主色去蓝（D17，2026-09-12）** ✅。
